...
app.config['MYSQL_USER'] ='rGUXbu0Sbh'
app.config['MYSQL_PASSWORD'] ='ENYGdgjhTi'
app.config['MYSQL_DB'] ='rGUXbu0Sbh'

app.config["MAIL_SERVER"] = 'smtp.gmail.com'
app.config['MAIL_PORT']=465
app.config['MAIL_USERNAME']="happyfamily.81@gmail.com"
app.config['MAIL_PASSWORD']=  "ilovedogs.81"
